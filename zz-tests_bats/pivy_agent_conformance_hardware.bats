#! /usr/bin/env bats
#
# Hardware-dependent Go conformance tests.
# Requires a YubiKey plugged in.
#
# Run:  just test-conformance-hardware
...
function go_conformance_hardware_tests_pass { # @test
  run "$CONFORMANCE_BIN" --hardware "$AGENT_SOCK"
  assert_success
